...
DROP POLICY IF EXISTS "Enable read access for authenticated users" ON public.google_calendar_integrations;
DROP POLICY IF EXISTS "Enable insert for authenticated users" ON public.google_calendar_integrations;
DROP POLICY IF EXISTS "Enable update for authenticated users" ON public.google_calendar_integrations;
DROP POLICY IF EXISTS "Enable delete for authenticated users" ON public.google_calendar_integrations;
