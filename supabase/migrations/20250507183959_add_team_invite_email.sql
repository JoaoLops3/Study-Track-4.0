...
-- NOTA: As seguintes configurações precisam ser feitas manualmente pelo administrador do banco de dados:
-- ALTER DATABASE postgres SET "app.settings.resend_api_key" = 'sua_chave_api_resend';
-- ALTER DATABASE postgres SET "app.settings.app_url" = 'https://seu-dominio.com'; 